...
const Main = () => {
	return (
		<div className='bg-purple-100 w-full'>
			<div className='p-64 grid grid-cols-2 h-screen bg-bg'>
				<div className='font-montserrat text-white z-10 relative'>
					<svg
						...
						className='absolute -z-10 -top-36 -left-36 mr-12 opacity-80'
					>
						<defs>
							<linearGradient
								id='linear-gradient'
							...
							>
								<stop offset='0.32' stopColor='#ff416c' />
								<stop offset='0.66' stopColor='#ff464e' />
							...
							<linearGradient
								...
								gradientUnits='userSpaceOnUse'
							>
								<stop offset='0' stopColor='#f94b81' />
								<stop offset='0.38' stopColor='#fb4b63' />
								<stop offset='1' stopColor='#ff4b2b' />
							</linearGradient>
						</defs>
						<title>splash</title>
